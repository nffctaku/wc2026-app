  ...
  return (
    <div style={{ display: "grid", gap: 10 }}>
      <div style={{ display: "flex", alignItems: "baseline", justifyContent: "space-between", gap: 12 }}>
        <div style={{ fontWeight: 900 }}>ランキング TOP{topN}</div>
        <Link href="/ranking" style={{ fontWeight: 900, fontSize: 12, color: "rgba(0,0,0,0.60)", textDecoration: "none" }}>
          全体を見る
        </Link>
      </div>
      ...
      <div style={{ display: "grid", gap: 8 }}>
        {rows.map((r) => (
          ...
          >
            <div style={{ fontWeight: 900, color: "rgba(0,0,0,0.55)", textAlign: "center" }}>{r.rank}</div>
            ...
            <div style={{ minWidth: 0 }}>
              <div style={{ fontWeight: 900, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{r.nickname}</div>
            </div>
